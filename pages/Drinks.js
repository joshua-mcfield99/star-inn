            ...
            <main>
                ...
                <section>
                    ...
                    <div className={`${styles.live_img}`}>
                        <Image cloudName="drkqjlsvr" publicId="/livebarimage/LiveBarImage" alt='This is the live bar image it displays our current ales which is updated daily.' style={{width: '100%'}}/>
                    </div>
                </section>
            </main>
        </>
